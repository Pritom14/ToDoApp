...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String TODOITEM = "com.ashishgru.MainActivity";
    ...
    public static final String SHARED_PREF_DATA_SET_CHANGED = "ashishgru.acagild.datasetchanged";
    public static final String CHANGE_OCCURED = "ashishgru.acagild.changeoccured";
    private int mTheme = -1;
    private String theme = "name_of_the_theme";
    public static final String THEME_PREFERENCES = "ashishgru.acagild.themepref";
    public static final String RECREATE_ACTIVITY = "ashishgru.acagild.recreateactivity";
    public static final String THEME_SAVED = "ashishgru.acagild.savedtheme";
    public static final String DARKTHEME = "ashishgru.acagild.darktheme";
    public static final String LIGHTTHEME = "ashishgru.acagild.lighttheme";
